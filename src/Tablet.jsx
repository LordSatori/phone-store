                    ...
                    <div className='d-flex flex-row w-100'>
                        ...
                        <div className='d-flex flex-md-row gap-4 flex-wrap container ms-3'>
                            {(() => {
                                ...
                                return filtered.map((tablet) => (
                                    <Link to={`/tablet/${tablet.id}`} className='text-decoration-none'>
                                        <Card className='card-hover' style={{ width: '17rem', height: '30rem' }}>
                                            <Card.Img className='bg-white' variant="top" src={tablet.image} />
                                            <Card.Body>
                                                <Card.Title className='text-primary fs-3'>{tablet.name}</Card.Title>
                                                <Card.Text className='text-secondary mt-3'>
                                                    Brand: <span className='fw-bold'>{tablet.brand}</span>
                                                </Card.Text>
